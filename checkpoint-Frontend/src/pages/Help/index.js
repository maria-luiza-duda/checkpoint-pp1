  ...
  return (
    <div className="help">
      ...
      <li>
            ...
            <img src={imagemRelatorio} className="helpimg" alt="Checkpoint" />
        ...
        <li>
            ...
            <img src={imagemCliente} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemEditestoque} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemEntrega} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemEstoque} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemPedidos} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemProduto} className="helpimg" alt="Checkpoint"/>
        ...
        <li>
            ...
            <img src={imagemMenu} className="helpimg" alt="Checkpoint"/>
